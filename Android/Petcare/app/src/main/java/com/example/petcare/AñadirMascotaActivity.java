...
public class AñadirMascotaActivity extends AppCompatActivity {
    ...
    private LinearLayout horasLayout;  // Contenedor dinámico para los botones de hora
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AñadirMascotaActivity.this, MisMascotasActivity.class);
            startActivity(intent);
        });

        notificas = findViewById(R.id.notiAnadirMascota);
        // Acción al presionar las Notificas
        notificas.setOnClickListener(v -> {
            // Redirigir al usuario a la actividad
            Intent intent = new Intent(AñadirMascotaActivity.this, NotificasActivity.class);
            startActivity(intent);
        });
        ...
        horasLayout = findViewById(R.id.linearLayoutHoras);  // Contenedor para los botones de hora
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        uploadTask.addOnSuccessListener(taskSnapshot -> {
            ...
            fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                imageView17.setImageURI(uri);  // Actualiza el ImageView con la imagen seleccionada
