...
public class AjustesNotificasActivity extends AppCompatActivity {
    ...
    private CheckBox checkBox1, checkBox3, checkBox4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.menu_option_mismascotas).setOnClickListener(v -> {
            Intent intent = new Intent(AjustesNotificasActivity.this, MiMascotaActivity.class);
            startActivity(intent);
            drawerLayoutAjustesNotificaciones.closeDrawer(GravityCompat.START);
        });
        ...
        notificas.setOnClickListener(v -> {
            // Redirigir al usuario a la actividad
            Intent intent = new Intent(AjustesNotificasActivity.this, AjustesNotificasActivity.class);
            startActivity(intent);
        });
